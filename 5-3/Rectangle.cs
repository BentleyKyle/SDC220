...
*
* The one major difference between this guided practice and the previous
* guided practice is the use of the keyword "override". Instead of
* providing a new function to print a rectangle, we simply override the
* base class function.
*/
