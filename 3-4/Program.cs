...
* Name: Kyle Bentley
* Date: 1/16/2025
* Assignment SDC220 Week 3 GP – Passing Arrays and Lists
*
* Main application (program) class.
* In this application we will demonstrate passing arrays and Lists as method
* parameters and returning arrays and Lists as method return values, which
...
public class PassingArrays
{
    static void Main(string[] args)
    {
        //Print a header line
        Console.WriteLine(
        "\nKyle Bentley - Week 3 GP Passing Arrays and Lists\n");
        ...
        Console.WriteLine("The average of the grades you entered is: {0}",
        avg);
        ...
        // grades - an advantage of using an List - we don't need to
    ...
    // Overloaded function to get grades from the user and return a List
    // of grades - note that we do not need to know how many grades will be
    // entered since we're using a List, allowing the user to determine
    // when they're done
    public static List<int> GetGrades()
    {
        // Create (declare) a List to hold grades - no need to give it a
        // size; we'll let the user decide when to stop
        List<int> grades = new List<int>();
        // Loop to get values from the user, storing them in an ArrayList to
        // return once we have the values; use a do-while loop so we always
        // get a value from the user, even if it's a -1 because they changed
        // their mind...users do that sometimes
        int grade = -1;
        do
        {
    ...
    // Overloaded function to get the average of the grades in a List;
    // use a for-each loop to get the total then divide it by the number of
    // items in the List
